...
const DiamondIcon = ({ size = 16, style = {} }) => (
  ...
  >
    <defs>
      <linearGradient id="diamondGradientP" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <>
            <h2 className="profile-name-title" style={{ display: "flex", alignItems: "center", gap: "8px", justifyContent: "center" }}>
              ...
              {(userProfile?.isBusiness || userProfile?.businessStatus === "verified") && (
                <span className="business-badge-verified" title="Empresa Verificada" style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}>
                  <DiamondIcon size={16} /> Verificado
                </span>
              )}
            </h2>
